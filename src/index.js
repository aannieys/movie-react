          ...
          <p id="output">
            {this.props.data.map((mv) => (
              <div onClick={() => this.handleCardClick(mv)}>
                <div className="card">
                  <img alt="description of image" src={`https://www.themoviedb.org/t/p/w600_and_h900_bestv2${mv.poster_path}`} />
                  <div class="info">
    ...
    if (this.state.click === true) {
      return (
        <p id="outputSelected">
          ...
          <img id="pic" alt="description of image" src={`https://www.themoviedb.org/t/p/w600_and_h900_bestv2${this.state.item.poster_path}`} />
          ...
          <img id="picBD" alt="description of image" src={`https://www.themoviedb.org/t/p/w600_and_h900_bestv2${this.state.item.backdrop_path}`} />
        </p>
      );
    }
  }
